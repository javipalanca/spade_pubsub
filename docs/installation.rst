...
The sources for SPADE PubSub can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/javipalanca/spade_pubsub
.. _tarball: https://github.com/javipalanca/spade_pubsub/tarball/master
